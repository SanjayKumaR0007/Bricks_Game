...
function ball_wall(){
  ...
  if(ball_bottom > paddle_y && (ball_left > paddle_x) && (ball_right < paddle_x+paddle_width ) ){
    ball_dy = -(ball_dy);
  }
...
function brick_collision(brick){
  ...
  if(ball_top <= brick_bottom && ball_top >= brick_top && ball_right >= brick_left && ball_left <= brick_right){
    ball_dy = -(ball_dy)
    brick.h = 0;
    brick.w = 0;
    brick.v = false;
...
// brick collision top
  if(ball_bottom >= brick_top && ball_bottom <= brick_bottom && ball_x >= brick_left && ball_x <= brick_right){
    ball_dy = -(ball_dy)
    brick.h = 0;
    brick.w = 0;
    brick.v = false;
...
// brick collision left
  if(ball_y <= brick_bottom && ball_y >= brick_top && ball_right >= brick_left && ball_right <= brick_right){
    ball_dx = -(ball_dx)
    brick.h = 0;
    brick.w = 0;
    brick.v = false;
  ...
  if(ball_y <= brick_bottom && ball_y >= brick_top && ball_left <= brick_left && ball_left >= brick_right){
    ball_dx = -(ball_dx)
    brick.h = 0;
    brick.w = 0;
    brick.v = false;
